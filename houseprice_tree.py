...
## 필요한 데이터 불러오기
house_train=pd.read_csv("shinydashboard/data/houseprice/train.csv")
house_test=pd.read_csv("shinydashboard/data/houseprice/test.csv")
sub_df=pd.read_csv("shinydashboard/data/houseprice/sample_submission.csv")
